module Spree::Admin::PaypalCheckoutPaymentsControllerDecorator
  def paypal_checkout_refund
    if request.get?
      ...
      response = @payment.payment_method.refund(@payment.source.transaction_id, @payment, params[:refund_amount])
      if response.success?
...
Spree::Admin::PaymentsController.prepend Spree::Admin::PaypalCheckoutPaymentsControllerDecorator
