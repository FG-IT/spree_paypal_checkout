module SpreePaypalCheckout
  module PaymentDecorator
    ...
    def cancel!
      if payment_method.is_a?(Spree::Gateway::PayPalCheckout) || payment_method.is_a?(Spree::Gateway::PayPalExpress)
    ...
    def void_transaction!
      ...
      protect_from_connection_error do
        if payment_method.payment_profiles_supported? or payment_method.is_a?(Spree::Gateway::PayPalCheckout) or payment_method.is_a?(Spree::Gateway::PayPalExpress)
